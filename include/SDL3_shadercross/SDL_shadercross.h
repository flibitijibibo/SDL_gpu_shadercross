 ...
 * - `SDL_SHADERCROSS_PROP_SPIRV_TARGET_ENV_STRING`: a UTF-8 value to be used as the target environment. Uses "vulkan1.0" by default. Relevant when using wave intrinsics, which require "vulkan1.1".
